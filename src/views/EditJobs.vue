                ...
                <form @submit.prevent="submitHandler">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="type" v-model="form.type" name="type"
                            class="border border-green-800 rounded w-full py-2 px-3" required>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" v-model="form.description" name="description"
                            class="border border-green-800 rounded w-full py-2 px-3" rows="4"
                    ...
                    <div class="mb-4">
                        ...
                        <select id="salary" v-model="form.salary" name="salary"
                            class="border border-green-800 rounded w-full py-2 px-3" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" v-model="form.location" id="location" name="location"
                            class="border border-green-800 rounded w-full py-2 px-3 mb-2" placeholder="Company Location"
                            required />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" v-model="form.company.name" id="company" name="company"
                            class="border border-green-800 rounded w-full py-2 px-3" placeholder="Company Name" />
                    </div>
